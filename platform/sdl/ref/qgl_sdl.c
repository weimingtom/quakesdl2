...
#define GPA(a) SDL_LoadFunction(_qgl_glso, a)
 ...
 * might be. */
qboolean QGL_Init(const char *soname) {

	_qgl_glso = SDL_LoadObject(soname);
	if (_qgl_glso == NULL) {
		ri.Con_Printf("QGL_Init: Can't open %s\n", soname);
		return false;
	}
